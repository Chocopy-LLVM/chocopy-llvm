...
main:
	...
	#NO_APP
	lui	s0, %hi(const_9)
	lw	a0, %lo(const_9+12)(s0)
	bgtz	a0, .LBB1_2
	call	error.OOB@plt
.LBB1_2:
	addi	a0, s0, %lo(const_9)
	lw	a0, 16(a0)
	lb	a0, 0(a0)
	call	initchars@plt
	lw	a1, %lo(const_9+12)(s0)
	li	a2, 1
	mv	s2, a0
	blt	a2, a1, .LBB1_4
	call	error.OOB@plt
.LBB1_4:
	lui	s1, %hi(const_9)
	addi	s0, s1, %lo(const_9)
	lw	a0, 16(s0)
	lb	a0, 1(a0)
	call	initchars@plt
	lw	a1, %lo(const_9+12)(s1)
	li	a2, 2
	mv	s1, a0
	blt	a2, a1, .LBB1_6
	call	error.OOB@plt
