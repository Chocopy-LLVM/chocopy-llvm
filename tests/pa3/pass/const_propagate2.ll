; ModuleID = 'Chocopy'
source_filename = "/Users/yiweiyang/project/bak/chocopy_test/pa3/pass/const_propagate2.py"
...
label63:                                                ; preds = %label6
  %op66 = call %$int$prototype_type* @makeint(i32 %op65)
  call void @print(%$int$prototype_type* %op66)
