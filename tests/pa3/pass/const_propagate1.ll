; ModuleID = 'Chocopy'
source_filename = "/Users/yiweiyang/project/bak/chocopy_test/pa3/pass/const_propagate1.py"
...
label74:                                                ; preds = %label2
  ...
  %op80 = call %$int$prototype_type* @makeint(i32 %op77)
  call void @print(%$int$prototype_type* %op80)
